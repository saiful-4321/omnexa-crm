<div class="offcanvas offcanvas-end" tabindex="-1" id="moduleFilter" aria-labelledby="moduleFilterLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="moduleFilterLabel">Filter Modules</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
        {!! Form::model(request()->all(), ['method' => 'get']) !!}
            <div class="mb-3">
                {!! Form::label('name', 'Module Name', ['class' => 'form-label text-muted font-size-13']) !!}
                <div class="input-group">
                    <span class="input-group-text bg-light border-end-0"><i class="mdi mdi-package-variant text-primary"></i></span>
                    {!! Form::text('name', null, ['class' => 'form-control border-start-0', 'id' => 'name', 'placeholder' => 'Enter Module Name']) !!}
                </div>
            </div>
